...
namespace UnityEngine.UI
{
    ...
    public class MyScroller : UIBehaviour, IInitializePotentialDragHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement, ILayoutElement, ILayoutGroup
    {
        ...
        [Serializable]
        public class MyScrollerEvent : UnityEvent<Vector2> {}
        ...
        [SerializeField]
        private MyScrollerEvent m_OnValueChanged = new MyScrollerEvent();
        public MyScrollerEvent onValueChanged { get { return m_OnValueChanged; } set { m_OnValueChanged = value; } }
        ...
        protected MyScroller()
        {
            flexibleWidth = -1;
        }
		
		//Implementation for ICanvasElement
